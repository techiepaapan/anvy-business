		...
		<div class="col-xs-12 col-sm-12 col-md-12 contact-content">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6">
						<div class="cnct-item">
						<a href="massventure://mail">
							<span><i class="fa fa-envelope-o"></i></span></a>
							<div>support@massventureindia.com</div>
						
						</div>
					</div>
					<div class="col-md-3 col-sm-6">
						<div class="cnct-item">
						<a href="massventure://call">
							<span><i class="fa fa-phone"></i></span></a>
							<div>+919567530184</div><br>
							<div>0471 2570571</div> 
							
						</div>
					</div>
					<div class="col-md-3 col-sm-6">
						<div class="cnct-item">
						<a href="massventure://web">
							<span><i class="fa fa-home"></i></span></a>
							<div>www.massventureindia.com<br></div>
