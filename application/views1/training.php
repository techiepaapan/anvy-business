...
<body>
	<div class="outer">
		...
		<div class="col-xs-12 col-sm-12 col-md-12 contact-content plan-content">
			<div class="container">
				<img src="<?php echo base_url();?>images/coming_soon.png" class="coming">
				<!--<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-4 event-outer">
						<div>
						<div class="ent-image">
							<img src="<?php echo base_url();?>images/default.jpeg" alt="">
						</div>
						<!--<div class="evny-cnt">
							<h5><i class="fa fa-calendar"></i> 16 January 2018</h5>
							<h4>new events entered</h4>
							<p>hfdjh fdrf gsgfhsf  a revolution in garment making and marketing across the country,our company has been established with an experience more than 8</p>
						</div>
						</div>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-4 event-outer">
