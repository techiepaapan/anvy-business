...
<!-- js -->
	...
	<script src="<?php echo base_url();?>js/Ajax/repurchase_products.js?t=<?php echo rand(10,1000);?>"></script>
...
<body>
 <input type="hidden" id="catidss" value="0">
	<div class="outer">
		...
		<!-- <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 cart">
			<div class="container">
				<p><a href="<?php //echo base_url();?>welcome/cart"><i class="fa fa-shopping-cart"></i> Cart<span></span></a></p>
			</div>
		</div> -->
		
		<div class="col-xs-3 col-sm-3 col-md-3  leftside">
			<div class="col-md-12" style="padding-top:65px;">
	        	<p class="shp_prd">CATEGORIES</p>
                        <p class="pr_name" id="0">ALL</p>
	        	 <?php 
    			//error_reporting(0);
    				$this->load->database();
    				...
    				?>
                           <p class="pr_name" id="<?php echo $catid;?>"><?php echo $catname?></p>
                   <?php }
               ?>
	        	<!--  <p class="pr_name">ALL</p>
	            <p class="pr_name">MENS</p>
	            <p class="pr_name">WOMANS</p>
	            <p class="pr_name">KIDS</p>
	            <p class="pr_name">FANCY</p>-->
	        </div>
	       
		</div>
		<!---products content-->
		<div class="col-xs-9 col-sm-9 col-md-9 product-content" id="pdt_cnt">
			<div class="container-fluid">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pre-nxt">
					...
					<button type="button" class="btn btn-primary nex" value="1">Next</button>
