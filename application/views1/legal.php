...
<body>
	<div class="outer">
		...
		<!--about us-->
		<!---contact content-->
		<div class="col-xs-12 col-sm-12 col-md-12 img-content about-content">
			<div class="container">
				...
				<div class="col-xs-12 certificates_outer">
						
						<div class="row">
						    <div class="certificates_inner">
						    		<h3>Certificate of Incorporation</h3>
						    		<a href="<?php echo base_url();?>dispdf/CERTIFICATE_OF_INCORPORATION.pdf" target="_blank">
											<img src="<?php echo base_url();?>images/CERTIFICATE_OF_ INCORPORATION.jpg">
									</a>
							</div>
						</div>
				</div>
