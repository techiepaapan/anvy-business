...
<script type="text/javascript" src="<?php echo base_url();?>js/Ajax/Add_cat.js"></script>
</head>
<body>
<div id="wrapper">
     <!-- Navigation -->
	   ...
	   <div class="xs">
  	    ...
  	    <div class="well1 white">
			...
			<div class="input-group" id="newpin">
				...
				<input  class="form-control1 input-search" placeholder="Add Category" type="text" id="add_catss">
				
			</div>
			<div class="register-button" style="float:none;" id="appendcat">
					<button class="btn btn-info  warning_2"  type="button" id="addcat_sub">ADD</button>
				</div>
      </div>
    </div>
