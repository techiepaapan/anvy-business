    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	     			...
	     			<!-- <form action="<?php //echo base_url();?>welcome/achiveact" enctype="multipart/form-data" method="post">
				            ...
				            <div class="form-group">
				              <label class="control-label"  for="scharge">Comments</label>
				              <textarea rows="" cols=""  class="form-control1"  name="ach_comment" id="ach_comment"></textarea>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	     			...
	     			<!-- <form action="<?php //echo base_url();?>welcome/achiveact" enctype="multipart/form-data" method="post">
				            ...
				            <div class="form-group">
				              <label class="control-label"  for="scharge">Comments</label>
				              <textarea rows="" cols=""  class="form-control1"  name="ach_comment1" id="ach_comment1"></textarea>
...
$( document ).ready(function()
{
		...
		$.getJSON(base_url+"welcome/loadtableval",function(jsn)
		{	
			...
			{	var n=0;
				...
				{	var ID=jsn[i].id;
					n++;
					$("#tdatas").append('<tr><td>'+n+'</td><td>'+jsn[i].name+'</td><td>'+jsn[i].comments+'</td><td><img style="width:150px; height:150px;" src="../../images/acheivers/'+jsn[i].image+'"></td><td><br><button class="edit" data-toggle="modal" data-target="#myModal1"  value="'+jsn[i].id+'">   Edit  </button></br><br><button class="delete" value="'+jsn[i].id+'">delete</button</br></td></tr>')
				}
		 ...
		 $(document).on('click','.delete', function()
		{
			 var del_id=$(this).val();
			 //alert(del_id);
			 $.getJSON(base_url+"welcome/deletedata?del_id="+del_id,function(jsn)
						{	
							 var mesg=jsn;
								if(mesg="success")
								{
		 ...
		 $(document).on('click','.edit', function()
		 {
			 ...
			 var ach_id=$(this).val();
		   //  alert(val1);
			 $.getJSON(base_url+"welcome/loadtabledata?ach_id="+ach_id,function(jsn)
						{	
							
							$('#ach_name1').val(jsn[0].name);
							$('#ach_comment1').val(jsn[0].comments);
							//$('#image1').val(jsn[0].image);
							$("#pik").prop('src',"../../images/acheivers/"+jsn[0].image);
						});	
