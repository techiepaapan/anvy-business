...
<script type="text/javascript" src="<?php echo base_url();?>js/Ajax/Activate.js"></script>
  ...
  <body>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		  <ul class="nav navbar-nav navbar-right">
			...
			<li class="active"><a href="<?php echo base_url();?>welcome/activate"><i class="fa  fa-user-plus" aria-hidden="true"></i>  Activate User</a></li>
	...
	<div class="col-xs-12 col-sm-12 main-body">
        ...
        <div class="row">
         ...
         $pid=$_SESSION['uid1'];
         $this->load->database();
         $query=$this->db->query("select * from user_login where u_id='$pid';");
         //echo $query->num_rows();
         $balance=0;
         if($query->num_rows()>0)
         {
         ...
         <div class="form-horizontal">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <button type="submit" class="btn btn-primary" id="submitt">Activate</button>
            </div>
          </div>
        </div>
              
        </div>
  <?php }else {echo "User Already Acivated";}?>
        </div>
